...
export PKG_TERARK_HOME=$PREFIX/terark-zip-rocksdb/pkg/terark-zip-rocksdb-Linux-x86_64-g++-5.4-bmi2-1
#export PKG_TERARK_HOME=$PREFIX/ssdb-chess/terark-zip-rocksdb
export LD_LIBRARY_PATH=$PKG_TERARK_HOME/lib:$PREFIX/ssdb-chess/rocksdb:$PREFIX/ssdb-chess/gflags/build/lib:/usr/mpc/lib:/usr/gmp/lib:/usr/mpfr/lib:/usr/isl/lib:/opt/gcc-5.4/lib64
